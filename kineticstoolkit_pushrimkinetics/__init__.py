...
def __dir__():
    return ['read_file', 'remove_offsets', 'calculate_forces_and_moments',
            'calculate_velocity', 'calculate_power']
...
def remove_offsets(
    ...
    if baseline_kinetics is None:
        ...
        recovery_index = _find_recovery_indices(kinetics.data['Moments'][:, 2])
